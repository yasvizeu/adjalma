...
const WEEKS = [
  {
    number: 1,
    title: "To Be, Pronouns, DO/Does",
    focus: "Estruturas afirmativas, negativas, interrogativas e pronomes",
    ...
    exercises: [
      ...
      "Escreva uma apresentação sua em inglês no seu caderno - cenário: apresentação de AA",
      "Escreva 4 frases no presente e depois passe para o passado",
